...
//q18
function sumOfElements(array, type) {
    let sum = 0;
    for (let i = 0; i < array.length; i++) {
...
//q19
function findIndex(num1, element) {
...
//q20
function findSmallestNumber(num2) {
    let smallest = num2[0];
...
//q21
function calculateProduct(numb) {
    let product = 1;
...
//q22
function filterByLength(word, n) {
    let filteredArray = [];
...
const operatorInput = prompt('Enter operator (+, -, * or / ): ');
if (operatorInput === null) {
    console.log('Operator input is null.');
    // Handle the null case, e.g., return from the function or do nothing
}
else {
    ...
    if (number1Input === null || number2Input === null) {
        console.log('Operand input is null.');
        // Handle the null case, e.g., return from the function or do nothing
    }
    else {
